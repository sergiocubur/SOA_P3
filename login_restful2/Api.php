...
include "Log.class.php";
 ...
 class Api extends Rest {  
   ...
   private function cliente_solicitar_pedido() {  /* YA */
    ...
    $log->insert('ORQUESTADOR:::::CLIENTE: Se solicita pedido', false, true, true);
  ...
  private function cliente_solicitar_estado_restaurante() {  
    ...
    $log = new Log("log", "./logs/");
    $log->insert('ORQUESTADOR:::::CLIENTE: Solicitar estado del pedido al restaurante', false, true, true);
  ...
  private function cliente_solicitar_estado_repartidor() {  
    ...
    $log = new Log("log", "./logs/");
    $log->insert('ORQUESTADOR:::::CLIENTE: Solicitar estado del pedido al repartidor', false, true, true);
  ...
  private function cliente_recibir_pedido() {  /* YA */
    ...
    $log = new Log("log", "./logs/");
    $log->insert('ORQUESTADOR:::::RESTAURANTE: recibir pedido del cliente', false, true, true);
  ...
  private function informar_pedido_cliente() {  
    ...
    $log = new Log("log", "./logs/");
    $log->insert('ORQUESTADOR:::::RESTAURANTE: informar pedido del cliente', false, true, true);
  ...
  private function avisar_pedido_listo_repartidor() {  /*YA*/
    ...
    $log = new Log("log", "./logs/");
    $log->insert('ORQUESTADOR:::::RESTAURANTE: Avisar al repartidor que ya está listo el pedido', false, true, true);
  ...
  private function recibir_pedido_restaurante() {  
    ...
    $log = new Log("log", "./logs/");
    $log->insert('ORQUESTADOR:::::REPARTIDOR:Recibir pedido del restaurante', false, true, true);
  ...
  private function informar_estado_pedido_cliente() {  
    ...
    $log = new Log("log", "./logs/");
    $log->insert('ORQUESTADOR:::::REPARTIDOR: Informar estado del pedido al cliente', false, true, true);
  ...
  private function marcar_entregado() {  /* Ya */
    ...
    $log = new Log("log", "./logs/");
    $log->insert('ORQUESTADOR:::::REPARTIDOR:Marcar como entregado', false, true, true);
